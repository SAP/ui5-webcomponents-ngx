...
export const basicMenu: Story = () => ({
  template: `<ui5-button (ui5Click)="menuBasic.showAt(ui5Button.element)" #ui5Button="ui5Button">Open Menu</ui5-button> <br/>
<ui5-menu #menuBasic="ui5Menu">
...
export const menuWithSubmenu: Story = () => ({
  template: `<ui5-button #btnOpenSubs="ui5Button" (ui5Click)="menuSubs.showAt(btnOpenSubs.element)">Open Menu</ui5-button> <br/>
<ui5-menu #menuSubs="ui5Menu">
    <ui5-menu-item text="New File" icon="add-document"></ui5-menu-item>
    <ui5-menu-item text="New Folder" icon="add-folder" disabled></ui5-menu-item>
...
export const MenuWithAdditionalTextOnMenuItems: Story = () => ({
  template: `<ui5-button #btnOpenAdditionalText="ui5Button" (ui5Click)="menuAdditionalText.showAt(btnOpenAdditionalText.element)">Open Menu</ui5-button> <br/>
<ui5-menu #menuAdditionalText="ui5Menu">
