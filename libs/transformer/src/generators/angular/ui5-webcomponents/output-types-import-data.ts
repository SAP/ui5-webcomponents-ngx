import { ComponentData, ImportData } from "../../../lib/types";
    ...
    Object.values(output.placeholderValues).forEach(types => {
      if (typeof types !== "string") {
        types.forEach(type => {
          ...
          importData.push({
            specifiers: [{
              local: cmp.exports[0].specifiers[0].exported,
              imported: cmp.exports[0].specifiers[0].exported
            }], path: cmp.relativePathFrom
          })
        })
      }
    });
